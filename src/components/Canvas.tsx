    ...
    <div className="">
      <div>
        <div
          ...
          className={
            fitMode === "full"
              ? "relative border border-slate-200 rounded-xl shadow-xl bg-white w-fit overflow-visible"
              : "relative border border-slate-200 rounded-xl shadow-xl bg-white overflow-hidden max-w-2xl"
          }
        ...
        >
                    ...
                    <>
                      {["top-left", "top-right", "bottom-left", "bottom-right"].map((pos) => (
                        <div
                          key={pos}
                          data-pos={pos}
                          className="absolute w-3 h-3 bg-white border border-slate-400 rounded-full hover:scale-110 transition-transform"
                          style={{
          ...
          {!data && (
            <div className="w-full text-xl h-80 flex items-center justify-center text-center rounded-xl shadow-lg border border-slate-200 text-slate-400">
              No Image Taken
            </div>
          )}
        </div>
